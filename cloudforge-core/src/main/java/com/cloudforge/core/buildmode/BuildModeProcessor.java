 ...
 * artifact as a {@code static final} field — not something a caller can influence by how the
 ...
 * image to detect at all, so that kind of check collapses to always-true inside the shipped
 * binary. A value fixed at compile time has no equivalent failure mode — it's a constant
 ...
 *
 * <p>Registered as a {@link javax.annotation.processing.Processor} in this module's own
...
public final class BuildModeProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        // just the one that wants a baked constant. TARGET_CLASS_OPTION absent is the
        ...
        // problem (missing/malformed value) become a reported misconfiguration error.
