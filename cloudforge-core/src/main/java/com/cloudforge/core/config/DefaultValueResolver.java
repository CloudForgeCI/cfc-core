...
public class DefaultValueResolver {
     ...
     * defaults.</p>
     */
    // codeql[java/unused-parameter] -- fieldInfo/framework are unused: this method is a
    // placeholder until FrameworkRules.getDefaultForField() exists.
    private static Object resolveFromFramework(ConfigFieldInfo fieldInfo, FrameworkRules<?> framework) {
        // TODO: Implement FrameworkRules.getDefaultForField().
        // Until then, frameworks can only apply defaults via applyDefaults(DeploymentConfig).
        return null;
    }
