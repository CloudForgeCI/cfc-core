...
/**
 * Test suite for StandardIAMConfiguration.
 *
 * Tests the standard IAM configuration for staging environments.
 */
class StandardIAMConfigurationTest {

    private StandardIAMConfiguration config;
    private App app;
    private Stack stack;
    ...
    @BeforeEach
    void setUp() {
        config = new StandardIAMConfiguration();
        app = new App();
    ...
    void testConfigurationExists() {
        // When: Creating StandardIAMConfiguration
        var cfg = new StandardIAMConfiguration();
    ...
    @Test
    void testKindReturnsStandard() {
        // When: Getting kind
        IAMProfile kind = config.kind();

        // Then: Should return STANDARD
        assertEquals(IAMProfile.STANDARD, kind);
    }
    ...
    void testIdReturnsCorrectValue() {
        ...
        // Then: Should return iam:STANDARD
        assertEquals("iam:STANDARD", id);
    }
    ...
    void testRulesNotNull() {
        ...
        SystemContext ctx = SystemContext.start(stack, TopologyType.JENKINS_SERVICE,
            RuntimeType.EC2, SecurityProfile.STAGING, IAMProfile.STANDARD, cfc);
    ...
    void testRulesForFargateRuntime() {
        ...
        SystemContext ctx = SystemContext.start(stack, TopologyType.JENKINS_SERVICE,
            RuntimeType.FARGATE, SecurityProfile.STAGING, IAMProfile.STANDARD, cfc);
    ...
    void testClassIsFinal() {
        ...
        Class<?> clazz = StandardIAMConfiguration.class;
    ...
    void testImplementsIAMConfiguration() {
        ...
        Class<?>[] interfaces = StandardIAMConfiguration.class.getInterfaces();
    ...
    void testPackageIsCorrect() {
        ...
        Package pkg = StandardIAMConfiguration.class.getPackage();
    ...
    void testHasPublicConstructor() {
        ...
        var constructors = StandardIAMConfiguration.class.getConstructors();
    ...
    void testCanInstantiate() {
        ...
        assertDoesNotThrow(() -> new StandardIAMConfiguration());
    }

    @Test
    void testKindMethodExists() throws NoSuchMethodException {
        // When: Getting kind method
        var method = StandardIAMConfiguration.class.getDeclaredMethod("kind");
    ...
    void testIdMethodExists() throws NoSuchMethodException {
        ...
        var method = StandardIAMConfiguration.class.getDeclaredMethod("id");
    ...
    void testRulesMethodExists() throws NoSuchMethodException {
        ...
        var method = StandardIAMConfiguration.class.getDeclaredMethod("rules", SystemContext.class);
    ...
    void testWireMethodExists() throws NoSuchMethodException {
        ...
        var method = StandardIAMConfiguration.class.getDeclaredMethod("wire", SystemContext.class);
    ...
    void testDifferentInstancesHaveSameKind() {
        // Given: Two instances
        StandardIAMConfiguration cfg1 = new StandardIAMConfiguration();
        StandardIAMConfiguration cfg2 = new StandardIAMConfiguration();
    ...
    void testHasExpectedMethodCount() {
        ...
        var methods = StandardIAMConfiguration.class.getDeclaredMethods();

        // Then: Should have expected methods (kind, id, rules, wire, createStandardEC2Role, createStandardFargateRoles)
